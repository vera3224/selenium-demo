...
//		ml.getElement("更多选项").click();
//		ml.getAction().moveToElement(ml.getElement("更多选项")).perform();
//		ml.getElement("更多选项").click();
		ml.getElement("商品筛选华为").click();
		ml.getElement("商品价格筛选").click();
		ml.getElement("更多选项").click();
		ml.getElement("商品颜色筛选").click();
		ml.getElement("商品类型").click();
		...
		sc.waitElementToBeNotDisplayed(sc.getElement("商品名称",sku));
		Assertion.verifyEquals(false, sc.isExist(sc.getElement("商品名称",sku)));
